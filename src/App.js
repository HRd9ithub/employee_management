    ...
    <>
      <div className='wrapper-container d-flex'>
        ...
        <div className='sidebar-wrap'>
          {(location.key === "default" && !GetLocalStorage("token")) || location.pathname === '/login' || location.pathname === '/forgot-password' || location.pathname === '/reset-password' || location.pathname === '/otp'? '' : <Sidebar />}
        </div>
