                ...
                <div className="col-12 d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <ul id="breadcrumb" className="mb-0">
                      ...
                      <li><NavLink to="/designation" className="ibeaker"><i class="fa-solid fa-play"></i> &nbsp; Designation</NavLink></li>
                    </ul>
                  </div>
                  <div className="d-flex" id="two">
                    ...
                    <DesignationModal getdesignation={getdesignation} accessData={accessData}  user={UserData && UserData.role.name}  records={records}/>
                  </div>
                </div>
              </div>
            </div>
