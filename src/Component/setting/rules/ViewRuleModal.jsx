          ...
          <div className=" grid-margin stretch-card inner-pages mb-lg-0" >
            <div className='card'>
              <div className="card-body pb-4">
                <h3>{ruleData.title}</h3>
                <div>
                  <div className='mb-0 py-2 px-0' style={{ background: "transparent" }} dangerouslySetInnerHTML={{ __html: ruleData.rules }}></div>
                </div>
              </div>
            </div>
          </div>
